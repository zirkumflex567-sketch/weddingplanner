...
const optionalVendorCategoryOptions: Array<{
  ...
  },
  {
    id: "catering",
    label: "Catering",
    copy: "Deaktivieren, wenn die Location oder die Familie das Essen übernimmt."
  },
  {
    id: "music",
    label: "Musik",
  ...
  },
  {
    id: "florals",
    label: "Floristik",
    copy: "Deaktivieren, wenn Deko und Blumen schon an anderer Stelle geklärt sind."
  },
  {
    id: "attire",
    label: "Styling & Outfit",
    copy: "Deaktivieren, wenn Kleidung, Styling oder Hair & Make-up hier keine Rolle spielen."
  }
];
...
function ProfileForm({
  ...
  return (
    <form className="guided-form" onSubmit={onSubmit}>
      ...
      <fieldset className="guided-events">
        <legend>Aktive Dienstleister-Kategorien</legend>
        <p className="guided-muted">
          Deaktivierte Kategorien verschwinden aus der Dienstleister-Ansicht, dem Budgetrahmen und dem geführten Ablauf.
        </p>
        <div className="guided-event-grid">
      ...
      {showInvitationFields ? (
        <fieldset className="guided-events guided-events--copy">
          <legend>Einladungstext für Rückmeldungen</legend>
          <p className="guided-muted">
...
function DashboardApp() {
  ...
  function createVendorInquiryDraft(vendor: VendorMatch) {
    ...
    const body = [
      ...
      "",
      `Könnt ihr uns bitte kurz Rückmeldung geben zu:`,
        ...
        <section className="panel-surface library-hero-card">
          <div className="library-hero-copy">
            ...
            <p className="library-body-copy">
              ...
              Schritt und behaltet Budget, Dienstleister, Gäste und Rückmeldungen in einer eleganten
            ...
            <div className="section-headline">
              <div>
                ...
                <p className="section-copy">
                  Jedes Profil merkt sich den aktuellen Beratungsschritt, Budgetstand und Rückmeldungen.
                </p>
              </div>
            </div>
      ...
      <section className="page-stack">
        <header className="page-hero">
          <div>
            ...
            <h1>Gästeliste mit Rückmeldungen, Essenswünschen und direktem Selbstservice.</h1>
            <p className="page-copy">
              Alles bleibt in einem Fluss: neue Gäste anlegen, Status ändern, öffentliche
              Antwort-Links versenden und Antworten ohne Neulade-Chaos wieder in den Workspace holen.
            </p>
          </div>
        ...
        <div className="page-grid page-grid--guests">
          ...
          <section className="experience-panel">
            <div className="section-headline">
              ...
              <p className="section-copy">
                Tische anlegen, Kapazitaeten setzen und Gäste direkt den Plätzen zuordnen.
              </p>
            </div>
    ...
    const dashboardMilestones = [
      {
        ...
        copy:
          ...
          "Location, Stil und Preisbild in einem ruhigen Vergleich zusammenziehen.",
        image:
          "https://images.unsplash.com/photo-1519167758481-83f550bb49b3?q=80&w=2098&auto=format&fit=crop",
        buttonLabel: "Location-Bereich öffnen",
        action: () =>
          goToPage("vendors", {
      ...
      },
      {
        ...
        copy:
          ...
          "Stilpräferenzen, Portfolio-Links und Fit-Scores bleiben direkt an den Dienstleistern.",
        image:
    ...
    return (
      <section className="page-stack">
        ...
        <section className="stat-grid">
          ...
          <article className="stat-card-panel">
            <p className="meta-label">Dienstleister in Bewegung</p>
        ...
        <header className="page-hero page-hero--centered">
          <div>
            ...
            <p className="page-copy">
              ...
              Fundament, Location, Dienstleister, Gäste, Admin und finale Abschlussübersicht.
            </p>
          </div>
        </header>
    ...
    const vendorSpotlights = [
      {
        key: "venue",
        label: "Locations",
        title: venueLead?.name ?? "Location-Shortlist",
      ...
      <section className="page-stack">
        <header className="page-hero">
          <div>
            ...
            <h1>Location-Shortlist und Kern-Dienstleister im selben stilvollen Workspace.</h1>
            <p className="page-copy">
          ...
          >
            Beratung für Dienstleister öffnen
          </button>
        </header>
        ...
        <div className="page-grid page-grid--vendors">
          <section className="experience-panel" id="venue-gallery">
            <div className="section-headline">
              <div>
                ...
                <h2>Alle lokalen Location-Treffer mit Quelle und Status</h2>
              </div>
            </div>
            {renderVenueStep()}
          </section>
          ...
          <section className="experience-panel" id="vendor-grid">
            <div className="section-headline">
              <div>
                <p className="eyebrow">Dienstleister-Bereich</p>
    ...
    return (
      <section className="page-stack">
        <header className="page-hero">
          ...
          >
            Dienstleister mit Budget verknüpfen
          </button>
        </header>
            ...
            <div className="transaction-list">
              {(workspace?.expenses ?? []).slice().reverse().map((expense) => (
                <article key={expense.id} className="transaction-row">
                  <div>
                    <strong>{expense.label}</strong>
                    <p>{expense.vendorName || "ohne Dienstleister-Zuordnung"}</p>
                  </div>
                  <div>
      ...
      <section className="page-stack">
        <header className="page-hero">
          <div>
            ...
            <h1>Profilfundament, Admin-Fristen und finale Abschlussübersicht in einer Ansicht.</h1>
            <p className="page-copy">
